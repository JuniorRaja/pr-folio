export type ProjectType = "Frontend" | "Backend" | "Full-stack" | "Web App" | "AI Chat" | "Website" | "Mobile";
...
export const projectsData: Project[] = [
  {
    ...
    toolsUsed: ["Vite", "React", "TypeScript", "Tailwind CSS", "Three.js", "Framer Motion", "React Router", "Vercel"],
    topicsCovered: [
  ...
  },
  {
    ...
    type: "Website",
    image: "/screenshots/pr-digital-resume-hero-zoomed-2025-11-16T21-10-24-891Z.png",
    ...
    summary: "A digital resume built with HTML, CSS, and JavaScript as an alternative to traditional PDF resumes. Features a responsive design with interactive elements and modern web technologies.",
    approach: "Created a modern digital resume replacing traditional PDF formats. Used semantic HTML for structure, custom CSS for styling and animations, and vanilla JavaScript for interactivity and dynamic content. Ensured responsive design across all devices and added professional typography and layout.",
    skillsDemonstrated: [
  ...
  },
  {
    ...
    type: "AI Chat",
    image: "/screenshots/brainwave-hero-zoomed-side-2025-11-16T21-10-39-950Z.png",
    ...
    summary: "A modern AI chat application built with React, featuring an intuitive interface for interacting with AI models. Uses Vite for fast development and Tailwind CSS for modern styling.",
    approach: "Developed an AI chat app using React and Vite for performance optimization. Integrated Tailwind CSS for responsive and modern UI design. Implemented features like hero section, features showcase, how-to-use guide, and pricing plans. Focused on user experience with smooth animations and clean layout.",
    skillsDemonstrated: [
  ...
  },
  {
    ...
    summary: "A visually stunning landing page for a metaverse platform built with Next.js 13, Tailwind CSS, and Framer Motion. Features immersive animations and modern UI design to showcase metaverse concepts.",
    approach: "Developed a cutting-edge landing page for a metaverse service using Next.js 13 for server-side rendering and performance. Implemented Tailwind CSS for rapid styling and consistent design system. Used Framer Motion for smooth animations and interactive elements. Structured the page with sections for world exploration, features, pricing, and insights.",
    skillsDemonstrated: [
  ...
  },
  {
    ...
    summary: "A modern banking application landing page built with ReactJS, featuring responsive design and modern UI components. Inspired by JavaScript Mastery tutorials, this project demonstrates banking app front-end development.",
    approach: "Developed a banking app landing page using React components with Vite for fast development. Applied Tailwind CSS for responsive styling and modern design systems. Created sections for service offerings, features, testimonials, and call-to-action elements. Focused on clean UI/UX design principles for financial applications.",
    skillsDemonstrated: [
