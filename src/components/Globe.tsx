...
import { Color, Scene, Fog, Group } from "three";
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    // Initialize data and material when the component mounts
    _buildData();
  ...
  }, [globeRef.current, defaultProps.globeColor, defaultProps.emissive]);
  ...
  return <primitive object={globeRef.current} position={[0, 0, 0]} scale={1} />;
}
